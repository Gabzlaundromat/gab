          ...
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">
                This could mean your services collection is empty or there are permission issues.
              </p>
              
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded max-w-md mx-auto">
                ...
                <ol className="text-left text-sm text-yellow-700 space-y-1">
                  <li>1. Update API key in scripts/seed-services.js</li>
                  <li>2. Run: npm install node-appwrite</li>
                  <li>3. Run: node scripts/seed-services.js</li>
                </ol>
              </div>
            </div>
          ) : services.length === 0 ? (
