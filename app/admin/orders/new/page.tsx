...
// Turns "0801 234 5678", "234801...", "+234801..." into the +234XXXXXXXXX
// shape the rest of the app (and the phone unique index) expects.
...
export default function NewManualOrderPage() {
  ...
  // ----- Services (needed for both the "repeat last order" mapping and the builder) -----
  ...
  // customer list and filters client-side — same workaround already used by
  // app/admin/customers/page.tsx. Fine at the current customer volume; would
  // need a real fulltext index + server-side search if that list grows a lot.
  ...
  const finalizeOrder = async (): Promise<Order | null> => {
    ...
    try {
      ...
      if (paymentMethod !== PaymentMethod.ONLINE && markPaidNow) {
        ...
        {phase === 'search' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {searchStatus === 'multiple' && (
              <div className="mt-6 border border-gray-200 rounded-lg divide-y divide-gray-100">
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  {customerOrders.length > 0 && (
                    <button
                      ...
                      className="bg-white border border-gray-300 hover:bg-gray-50 disabled:opacity-50 text-gray-700 px-5 py-2 rounded-md font-medium transition-colors"
                    >
              ...
              <div className="mt-6 border border-blue-200 bg-blue-50 rounded-lg p-5">
                ...
                <div className="mt-4 flex gap-3">
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white px-5 py-2 rounded-md font-medium transition-colors"
                  >
